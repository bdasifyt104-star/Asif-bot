...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "দুঃখিত আপনার কথাটির মেয়াদ শেষ অনুগ্রহ করে রিচার্জ করুন 😐😸",
          "বেশি bot bot করলে লিফ্ট নিবো কিন্ত 😡😡",
          "—হাজারো লুচ্চা লুচ্চির ভিরে-🙊🥵আমার বস আসিফ এক নিস্পাপ ভালো মানুষ-🥱🤗🙆‍♂️",
          "দুঃখিত আপনার কথায় নেটওয়ার্ক পাচ্ছে না অনুগ্রহ করে কিছুক্ষন পর আবার চিষ্টা করুন🫢🐸",
          ...
          "হুম janu বলো তোমার জন্যে কি করতে পারি 👻🙂‍↕️",
          "⎯🙂🙂বে্ঁয়া্ঁদ্ঁবি্ঁ মা্ঁপ্ঁ ক্ঁর্ঁবে্ঁন্ঁ🫡আ্ঁপ্ঁনা্ঁকে্ঁ এ্ঁক্ঁটা্ঁ থা্ঁপ্প্ঁর্ঁ মা্ঁর্ঁতে্ঁ চা্ঁই্ঁ 🫢💙🪽"
        ];
